...
def gbanstat(update, context):
    ...
    if len(args) > 0:
        if args[0].lower() in ["on", "yes"]:
            ...
            update.effective_message.reply_text(
                "I've enabled Spam Guard in this group. This will help protect you "
                "from spammers, unsavoury characters, and the biggest trolls.")
        elif args[0].lower() in ["off", "no"]:
            sql.disable_gbans(update.effective_chat.id)
            update.effective_message.reply_text(
                "I've disabled Spam shield in this group. Spam Guard wont affect your users "
        ...
        update.effective_message.reply_text(
            ...
            "When True, Any Spam Guard that happen will also happen in your group. "
