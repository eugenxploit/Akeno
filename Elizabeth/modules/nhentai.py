...
from Elizabeth import telegraph



@nyaa.on_message(~filters.me & filters.command('nhentai', prefixes='/'), group=8)
...
@nyaa.on_inline_query(filters.regex(r'^nhentai (\d+)$'))
...
def nhentai_data(noombers):
    ...
    post = telegraph.create_page(
        ...
        author_name="@AkenoHimejimaChatBot", 
        author_url="https://t.me/AkenoHimejimaChatBot"
    )
