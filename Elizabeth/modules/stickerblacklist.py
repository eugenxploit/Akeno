...
import Elizabeth.modules.sql.blsticker_sql as sql
...
from Elizabeth.modules.helper_funcs.alternate import send_message
...
⚙️ *NOTE:* Blacklist stickers do not affect the group admin.
